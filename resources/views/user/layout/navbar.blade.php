...
if ($currentUser) {
    ...
    $chatUrl = "https://xlserp.com/customersupport/chat/login?auth_token=" . urlencode($token);
} else {
    $chatUrl = "https://xlserp.com/customersupport/chat/login";
}
?>

<div class="main-header">
    <div class="logo">
        <img src="{{ asset('templateassets/images/logo2.png') }}" style="width:35%;height:7vh" alt="">
    </div>
    ...
    <div class="header-part-right">
        ...
        --}}
        <!-- Notificaiton End -->
                      <a href="{{ $chatUrl }}" target="_blank"><img src="{{asset ('templateassets/images/customer-service-icon.png') }}" class="w-20 header-icon d-none d-sm-inline-block"></a>  
        <!-- User avatar dropdown -->
        <div class="dropdown">
            <div class="user col align-self-end">
                <img src="{{asset ('templateassets/images/images.png') }}" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<div class="side-content-wrap">
    @if(auth()->check() && auth()->user()->notifications > 0)
    <span class="notification-dot"></span>
@endif
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
        <ul class="navigation-left">
            <li class="nav-item"><a class="nav-item-hold" href="{{route('user.dashboard')}}"><i class="nav-icon i-Bar-Chart"></i><span class="nav-text">Dashboard</span></a>
            ...
            <li class="nav-item">
               ...
               {{-- <a class="nav-item-hold" href="https://xlserp.com/customersupport/chat/login" target="_blank"><i class="nav-icon i-Speach-Bubble-3"></i><span class="nav-text">Chat</span></a>
                --}}
                <a class="nav-item-hold" href="{{ $chatUrl }}" target="_blank"><i class="nav-icon i-Speach-Bubble-3"></i><span class="nav-text">Chat</span></a>
                <div class="triangle"></div>
            </li>
            <li class="nav-item" ><a class="nav-item-hold" href="{{ route('user.projectdetail') }}"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Projects</span></a>
                <div class="triangle"></div>
            </li>

            <li class="nav-item" ><a class="nav-item-hold" href="{{ route('user.complain') }}"><i class="nav-icon i-Suitcase"></i><span class="nav-text">Ticket</span></a>
                <div class="triangle"></div>
            </li>
              <li class="nav-item " ><a class="nav-item-hold" href="{{ route('user.payment') }}"><i class="nav-icon i-Double-Tap"></i><span class="nav-text">Billing</span></a>
                <div class="triangle"></div>
            </li>
    ...
    <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
        ...
        <ul class="childNav" data-parent="apps">
            ...
            <li class="nav-item"><a href="{{ route('user.inbox') }}"><i class="nav-icon i-Email"></i><span class="item-name ">Inbox</span></a></li>
            <li class="nav-item"><a href="http://127.0.0.1:8001/chatify"><i class="nav-icon i-Speach-Bubble-3"></i><span class="item-name">Chat</span></a></li>
        </ul>
        ...
        <ul class="childNav" data-parent="sessions">
            <li class="nav-item"><a href="{{ route("admin.registeredusers") }}"><i class="nav-icon i-Checked-User"></i><span class="item-name">Registered Users</span></a></li>
        </ul>
...
<!-- Include this script in the layout or template used by relevant pages -->
