...
<div class="main-header">
    <div class="logo">
        <a href="https://xlserp.com/customersupport/admindashboard"><img src="{{ asset('templateassets/images/logo2.png') }}" style="width:35%;height:7vh" alt=""></a>
    </div>
...
<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
        <ul class="navigation-left">
             <li class="nav-item" ><a class="nav-item-hold" href="{{route ('admin.complain') }}"><i class="nav-icon i-Bar-Chart"></i><span class="nav-text">Tickets</span></a>
                <div class="triangle"></div>
            </li>
            <!--route('admin.userquestion')-->
            <li class="nav-item"><a class="nav-item-hold" href=""><i class="nav-icon i-Library"></i><span class="nav-text">User Questions</span> <small style="color:red;">under development</small></a>
                <div class="triangle"></div>
            </li>
            <li class="nav-item" ><a class="nav-item-hold" href="{{ route('admin.chats.chatsfetch') }}"><i class="nav-icon i-Suitcase"></i><span class="nav-text">Late Messages</span></a>
                <div class="triangle"></div>
            </li>
            <!--<li class="nav-item" ><a class="nav-item-hold" href="{{ route('admin.chats') }}"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Chats</span></a>-->
            <!--    <div class="triangle"></div>-->
            <!--</li>-->
            <li class="nav-item"><a class="nav-item-hold" href="{{ route('admin.projectform') }}"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">ClientsData</span></a>
                <div class="triangle"></div>
           </li>

           <li class="nav-item"><a class="nav-item-hold" href="{{ route('admin.completefollowup') }}"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Completed Task</span></a>
                <div class="triangle"></div>
           </li>

           <li class="nav-item"><a class="nav-item-hold" href="{{ route('admin.followup') }}"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Dialy Followup Task</span></a>
                <div class="triangle"></div>
           </li>
            ...
            <li class="nav-item" data-item="sessions"><a class="nav-item-hold" href="#"><i class="nav-icon i-Administrator"></i><span class="nav-text">Manage Account</span></a>
                <div class="triangle"></div>
            </li>
    ...
    <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
        ...
        <ul class="childNav" data-parent="sessions">
            ...
            <li class="nav-item"><a href="{{ route("admin.registeredteammembers") }}"><i class="nav-icon i-Checked-User"></i><span class="item-name">Registered Team</span></a></li>
        </ul>
