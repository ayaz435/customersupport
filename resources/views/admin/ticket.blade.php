                ...
                <div class="card-body ul-card__widget-chart">
                    <div class="ul-widget__chart-info">
                        ...
                        <div class="ul-widget__chart-number">
                            <h2 class="t-font-boldest">Total Completed Tickets Against Services</h2><span class="fs-5"><b>{{$count1}}</b></span>
                        </div>
                    </div>
            ...
            <div class="card mb-4 o-hidden">
                <div class="card-body ul-card__widget-chart">
                    <div class="ul-widget__chart-info">
                        ...
                        <div class="ul-widget__chart-number">
                        <h2 class="t-font-boldest">Total In Progress Tickets Against Services</h2><span class="fs-5"><b>{{$count2}}</b></span>
                        </div>
                    </div>
            ...
            <div class="card mb-4 o-hidden">
                <div class="card-body ul-card__widget-chart">
                    <div class="ul-widget__chart-info">
                        ...
                        <div class="ul-widget__chart-number">
                        <h2 class="t-font-boldest">Total Received Tickets Against Services</h2><span class="fs-5"><b>{{$count3}}</b></span>
                        </div>
                    </div>
