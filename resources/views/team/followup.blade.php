...
<div class="main-content">
    <div class="breadcrumb">
        ...
        <ul>
            <li><a href="#">Clients For Follow Up</a></li>
            <li>Version 4</li>
        </ul>
    </div>
    ...
    <div class="row mb-4">
                ...
                <div class="card-body ul-card__widget-chart">
                    <div class="ul-widget__chart-info">
                        ...
                        <div class="ul-widget__chart-number">
                            <h2 class="t-font-boldest">Total FollowUp Tasks</h2><span class="fs-5"><b>{{$count1}}</b></span>
                        </div>
                    </div>
        ...
        <div class="col-md-4 col-lg-4">
            <a href="{{route('team.followup6')}}">
            <div class="card mb-4 o-hidden">
                <div class="card-body ul-card__widget-chart">
                    <div class="ul-widget__chart-info">
                        <h5 class="heading">Customers 6 months old</h5>
                        <div class="ul-widget__chart-number">
                        <h2 class="t-font-boldest">Total FollowUp Tasks</h2><span class="fs-5"><b>{{$count2}}</b></span>
                        </div>
                    </div>
        ...
        <div class="col-md-4 col-lg-4">
            <a href="{{route('team.followup9')}}">
            <div class="card mb-4 o-hidden">
                <div class="card-body ul-card__widget-chart">
                    <div class="ul-widget__chart-info">
                        <h5 class="heading">Customers 1 Year old</h5>
                        <div class="ul-widget__chart-number">
                        <h2 class="t-font-boldest">Total FollowUp Tasks</h2><span class="fs-5"><b>{{$count3}}</b></span>
                        </div>
                    </div>
